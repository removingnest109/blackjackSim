...
// Basic-strategy charts. inline constexpr bakes them straight into the binary
// as read-only data and lets getAction be evaluated at compile time.
inline constexpr Action HARD[22][12] = {
...
inline constexpr Action SOFT[22][12] = {
...
inline constexpr Action PAIR[12][12] = {
...
constexpr Action getAction(int total, int dealerUp, bool isSoft, bool isPair,
                           int pairRank) {
  if (isPair)
